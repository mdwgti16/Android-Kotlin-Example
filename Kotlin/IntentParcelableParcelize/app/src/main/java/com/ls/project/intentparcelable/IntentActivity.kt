...
class IntentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (i in person.map){
            ...
            hashMap["id"]=i.key
            hashMap["password"]=i.value
            mapList.add(hashMap)
        }
        val mapAdapter = SimpleAdapter(this,mapList,android.R.layout.simple_list_item_2, arrayOf("id","password"),intArrayOf(android.R.id.text1,android.R.id.text2))
